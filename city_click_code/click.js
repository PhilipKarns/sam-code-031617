...
$(".button").on("click",function() {
  ...
  var chatTitle = $("<a href= https://www.google.com/webhp?sourceid=chrome-instant&rlz=1C1CHBF_enUS730US730&ion=1&espv=2&ie=UTF-8#q=" + $(this).attr('id').replace('#', '') + "&*</a>" + "<h3>"+ $(this).attr('id') + "</h3>" target="_blank") ;
